...
ROWS = [
    (AP, "The Price of Decentralization in Block Building", "2026-06-01",
     "Burak Öz (Flashbots), Fei Wu (Flashbots), Luis Correia (Flashbots), Sen Yang (Flashbots), Bruno Mazorra (Flashbots), Stefanos Leonardos",
    ...
    (AP, "Geographical Centralization Resilience in Ethereum’s Block-Building Paradigms", "2026-01-19",
     "Sen Yang, Burak Öz (Flashbots), Fei Wu, Fan Zhang",
    ...
    (AP, "The Free Option Problem of ePBS", "2025-09-29",
     "Bruno Mazorra, Burak Öz, Christoph Schlegel, Quintus Kilbourn",
     "https://arxiv.org/abs/2509.24849"),
    (AP, "Geographic Decentralization Simulation", "2025-09-25",
     "Burak Öz, Sen Yang",
    ...
    (AP, "Cross-Chain Arbitrage", "2025-01-28",
     "Burak Öz, Bruno Mazorra, Christoph Schlegel",
    ...
    (AP, "A Study of MEV Extraction Techniques on a First-Come-First-Served Blockchain", "2023-08-12",
     "Burak Öz (Flashbots), Jonas Gebele, Parshant Singh, Filip Rezabek, Florian Matthes",
    ...
    (AP, "Just-in-Time Resale in an Ahead-of-Time Auction: An Event Study", "2026-03-23",
     "Burak Öz (Flashbots), Christoph Schlegel (Flashbots), Akaki Mamageishvili",
     "https://arxiv.org/abs/2603.20175"),

    (FW, "Why Location Choice Matters", "2026-08-08",
     "Burak Öz, Fei Wu, Luis Correia, Sen Yang, Bruno Mazorra",
