...
2. Develop a taxonomy of backrun games in terms of the information and actions available to would-be backrunners. Does the backrunner knows the number and contents of trades in the block, which trades they will backrun, or some function of these? Does the backrunner set a target price for each trade they handle or one for the whole block? 
